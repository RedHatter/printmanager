...
export default function HistoryDialog ({ model, onClose }) {
  ...
  return <Dialog open maxWidth={ !selected && 'sm' }>
    <DialogContent>
      { selected ? <Fragment>
      ...
      : <Table>
        ...
        <TableBody>
          { patches.map((o, i) => (
            <TableRow key={ o._id } hover={ i != 0 } onClick={ i != 0 ? (() => select(o)) : undefined }>
    ...
    <DialogActions>
      { selected && <Button onClick={ () => setSelected(undefined) }>Back</Button> }
